...
function brMenuIcon(label) {
  ...
  const icons = {
    ...
    jacket: `<path d="M8 4l-3 4v12h6v-8h2v8h6V8l-3-4"/><path d="M9 4c.7 1.2 1.7 1.8 3 1.8s2.3-.6 3-1.8"/><path d="M8 9h3M13 9h3"/>`,
    ...
    shoe: `<path d="M4 15.5c3.8 2 9.5 2.7 16 1.2V20H5.5C3.5 20 2 18.8 2 17v-1.5z"/><path d="M7.5 10.5c2.5 2.6 6 4 12.5 5"/><path d="M10 13l1.5-1M13 14l1.5-1"/>`,
    boot: `<path d="M8 4h7v8l5 3v4H5v-4l3-2z"/><path d="M8 9h7M8 13h5M5 17h15"/>`,
    dressshoe: `<path d="M4 15.5c4 2 10 2.5 16 .8V20H5.5C3.5 20 2 18.8 2 17v-1.5z"/><path d="M9 12.5h6M11 10.5h5M13 8.5h3"/>`,
    heel: `<path d="M5 15.5c4 1.8 9 2 14 .6L20 19H6c-2 0-3.5-1.1-3.5-2.6z"/><path d="M15.5 16.5 18 22"/><path d="M8 13c2 .8 4 .9 6 .4"/>`,
    flatshoe: `<path d="M4 15.5c3.5 1.8 9 2.1 16 1V20H5.5C3.5 20 2 18.8 2 17v-1.5z"/><path d="M8 14c2.5.8 5.5.9 9 .2"/>`,
    slipon: `<path d="M4 15.5c4 2 10 2.2 16 .8V20H5.5C3.5 20 2 18.8 2 17v-1.5z"/><path d="M8 14c2-2 6-2 8 0"/>`,
    sandal: `<path d="M4 16c4 1 10 1.2 16 0v4H5.5C3.5 20 2 18.9 2 17.2z"/><path d="M8 10l4 6M16 10l-4 6M9 10h6"/>`,
    slipper: `<path d="M5 15c4.5-2.2 10-2 14 1v4H5.5C3.5 20 2 18.8 2 17v-1z"/><path d="M8 14c2-1 5-1 8 .3"/>`,
    runningshoe: `<path d="M4 15.5c4 2 10 2.3 16 .8V20H5.5C3.5 20 2 18.8 2 17v-1.5z"/><path d="M8 11l2 2M12 10l2 2M16 10.5l2 2"/><path d="M6 18h13"/>`,
    hiking: `<path d="M8 4h7v8l5 3v4H5v-4l3-2z"/><path d="M8 9h7M8 13h6M6 17h14"/><path d="M10 10l2 2M13 10l2 2"/>`,
