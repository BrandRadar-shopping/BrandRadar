...
function brMenuIcon(label) {
  ...
  const icons = {
    ...
    shoe: `<path d="M3 16.5h18v2.2c0 .7-.6 1.3-1.3 1.3H5.8C3.7 20 2 18.3 2 16.2v-.7c2.8.9 5.2.8 7.2-.2 1.6-.8 2.8-2.1 3.8-3.8l1.8 2.1c1.3 1.5 3.2 2.4 5.2 2.4H21"/><path d="M8.5 14.8l1.5-2.6M11.2 13.6l1.3-2.2M14.4 13.9l1.5-1.3"/>`,

boot: `<path d="M8 3.8h7.5v8.4l4.5 3.1V20H5v-4.7l3-2.3z"/><path d="M8 8h7.5M8 12h7.5M5 17h15"/>`,

dressshoe: `<path d="M3 16.2c4.5 1.8 10.3 1.8 17.5.1V20H5.5C3.6 20 2 18.4 2 16.5z"/><path d="M8.5 14.1c2.1-.1 4.4-.7 6.8-2.1l3.2 3.2"/><path d="M11 11.8h5M13 9.8h3.5"/>`,
...
slipper: `<path d="M3 16.4c3.4-2.2 9.8-2.5 17.5.1V20H5.5C3.6 20 2 18.4 2 16.5z"/><path d="M8 15c2.5-1 5.5-1 8.8.2"/>`,

runningshoe: `<path d="M3 16.3c4.7 1.9 10.5 1.8 17.5.1V20H5.5C3.6 20 2 18.4 2 16.5z"/><path d="M7 12.5l2 2M10.5 11.2l2 2M14 10.8l2.2 2.2"/><path d="M5.5 18h13.5"/>`,

hiking: `<path d="M8 4h7.5v8l4.5 3.3V20H5v-4.7l3-2.3z"/><path d="M8 8h7.5M8 12h7.5M6 17h14"/><path d="M9.8 9.5l2 2M13 9.5l2 2"/>`,
